#!/bin/bash
# create_wordpress_server_keypair.sh
# -----------------------------------------------------------------------------
# Purpose : create and upload keypair for new domains
# -----------------------------------------------------------------------------
# Usage :
#   $ create_wordpress_server_keypair.sh env domain
